...
from src.core.llm import LLMRouter, TaskComplexity
...
class ADRRecorderAgent(BaseAgent):
    ...
    def __init__(self, router: LLMRouter | None = None, qdrant_client: Any = None, embedding_client: Any = None):
        super().__init__(router)
        self.capture = DecisionCaptureAgent(self.llm_client)
        self.writer = ADRWriter(self.llm_client)
